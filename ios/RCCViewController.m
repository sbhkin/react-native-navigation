...
- (void)viewWillAppear:(BOOL)animated
{
  ...
  if(self.navigatorStyle[@"navBarBackgroundColor"]) {
  ...
  void (^action)() = ^ {
    if (navBarTransparentBool)
    {
      if (![viewController.navigationController.navigationBar viewWithTag:TRANSPARENT_NAVBAR_TAG])
      {
        ...
        [viewController.navigationController.navigationBar setBackgroundImage:[UIImage imageWithColor:[UIColor clearColor]] forBarMetrics:UIBarMetricsDefault];
    ...
    else
    {
      ...
      if (transparentView)
      {
        ...
        if(self.navigatorStyle[@"navBarBackgroundColor"]) {
          ...
          NSString *navBarBackgroundColor = self.navigatorStyle[@"navBarBackgroundColor"];
          UIColor *color = navBarBackgroundColor != (id)[NSNull null] ? [RCTConvert UIColor:navBarBackgroundColor] : nil;
          [transparentView setBackgroundColor:color];
        }else{
          [transparentView removeFromSuperview];
        }
        //      [viewController.navigationController.navigationBar setBackgroundImage:self.originalNavBarImages[@"bgImage"] forBarMetrics:UIBarMetricsDefault];
...
-(void)setStyleOnDisappear
{
  ...
  //  {
  //    [transparentView removeFromSuperview];
  //    UIImage *img = self.originalNavBarImages[@"bgImage"];
  //    [self.navigationController.navigationBar setBackgroundImage:[img resizableImageWithCapInsets:UIEdgeInsetsZero resizingMode:UIImageResizingModeStretch] forBarMetrics:UIBarMetricsDefault];
  //
